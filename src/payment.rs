...
Security
Insights
NFT/contracts/rust/src/lib.rs
@janedegtiareva
janedegtiareva Update to near-sdk-rs 0.11.0 and fix collection usage to use new syntax
Latest commit 4c55057 on Jun 10, 2020
 History
 2 contributors
@mikedotexe@janedegtiareva
398 lines (350 sloc)  15 KB
...
mod tests {
    ...
    // fn client_one() -> String {
    //     "client-one.testnet".to_string()
    // }
    // fn client_two() -> String {
    //     "client-one.testnet".to_string()
    // }

    // // part of writing unit tests is setting up a mock context
    // // this is a useful list to peek at when wondering what's available in env::*
    // fn get_context(predecessor_account_id: String, storage_usage: u64, is_view: bool) -> VMContext {
    //     VMContext {
    //         current_account_id: "alice.testnet".to_string(),
    //         signer_account_id: "jane.testnet".to_string(),
    //         signer_account_pk: vec![0, 1, 2],
